...
for { set i $ns } { $i <= $nk } { incr i } {
      ...
      set atom2 [atomselect top "resname $mol and name C33 and resid <=100"]
      set atom3 [atomselect top "resname $mol and name C9 and resid <=100"]
      set atom4 [atomselect top "resname $mol and name C28 and resid <=100"]
