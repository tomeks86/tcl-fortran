...
for { set k 1 } { $k <=12} { incr k } {
     set atom1 [atomselect top "resid $j1 and name $l1($k) and not waters"]
     set atom2 [atomselect top "resid $j1 and name $l1([expr $k+1]) and not waters"]
     set atom3 [atomselect top "resid $j1 and name $l2($k) and not waters"]
     set atom4 [atomselect top "resid $j1 and name $l2([expr $k+1]) and not waters"]
