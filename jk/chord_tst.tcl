...
foreach v1 [$atom1 get {x y z}] v2 [$atom2 get {x y z}] v3 [$atom3 get {x y z}] v4 [$atom4 get {x y z}] v5 [$atom5 get {x y z}] v6 [$atom6 get {x y z} ] v7 [$atom7 get {x y z}] {
...
foreach  v8 [$atom8 get {x y z} ] v9 [$atom9 get {x y z} ] v10 [$atom10 get {x y z} ] v11 [$atom11 get {x y z} ] v12 [$atom12 get {x y z} ] v13 [$atom13 get {x y z}] {
...
puts " $licznik " 
puts  " [expr $order1/$licznik ] "
puts  " [expr $order2/$licznik ] "
puts  " [expr $order3/$licznik ] "
puts  " [expr $order4/$licznik ] "
puts  " [expr $order5/$licznik ] "
puts  " [expr $order6/$licznik ] "
puts  " [expr $order7/$licznik ] "
puts  " [expr $order8/$licznik ] "
puts  " [expr $order9/$licznik ] "
puts  " [expr $order10/$licznik ] "
puts  " [expr $order11/$licznik ] "
puts  " [expr $order12/$licznik ] "
