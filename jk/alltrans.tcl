...
foreach v1 [$atom1 get {x y z} ] v2 [$atom2 get {x y z} ] v3 [$atom3 get {x y z} ] v4 [$atom4 get {x y z} ] v5 [$atom5 get {x y z} ] v6 [$atom6 get {x y z} ] v7 [$atom7 get {x y z} ] v8 [$atom8 get {x y z} ] v9 [$atom9 get {x y z} ] v10 [$atom10 get {x y z} ] v11 [$atom11 get {x y z} ] v12 [$atom12 get {x y z} ] v13 [$atom13 get {x y z} ]  {
      ...
      set o1 [expr [vecdot $dv1 $dv3]/([veclength $dv1 ]*[veclength $dv3])  ]
      set o2 [expr [vecdot $dv2 $dv4]/([veclength $dv2 ]*[veclength $dv4])  ]
      set o3 [expr [vecdot $dv3 $dv5]/([veclength $dv3 ]*[veclength $dv5])  ]
      set o4 [expr [vecdot $dv4 $dv6]/([veclength $dv4 ]*[veclength $dv6])  ]
      set o5 [expr [vecdot $dv5 $dv7]/([veclength $dv5 ]*[veclength $dv7])  ]
      set o6 [expr [vecdot $dv6 $dv8]/([veclength $dv6 ]*[veclength $dv8])  ]
      set o7 [expr [vecdot $dv7 $dv9]/([veclength $dv7 ]*[veclength $dv9])  ]
      set o8 [expr [vecdot $dv8 $dv10]/([veclength $dv8 ]*[veclength $dv10])  ]
      set o9 [expr [vecdot $dv9 $dv11]/([veclength $dv9 ]*[veclength $dv11])  ]
      set o10 [expr [vecdot $dv10 $dv12]/([veclength $dv10 ]*[veclength $dv12])  ]
